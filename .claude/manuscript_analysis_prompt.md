...
- **Note: GROBID frequently garbles text** — concatenating adjacent entries, dropping characters, or splitting fields. Flag issues you find in the GROBID data, but be aware they may be extraction artifacts. A separate verification agent will check your flagged issues against the actual PDF and remove artifacts.
